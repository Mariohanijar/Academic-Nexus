	...
	public static void main(String[] args) {
		...
		enviarButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (camposCadastroPreenchidos(nomeDirField, idDirField, cpfDirField, emailDirField,
						dataContratacaoField, nomeInstField, enderecoInstField, idInstField, anoFundacaoInstField)) {
		...
		enviarProfButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (camposCadastroPreenchidos(nomeProfField, idProfField, cpfProfField, emailProfField,
						dataContratacaoProfField)) {

					Professor professor = new Professor(nomeProfField.getText(), emailProfField.getText(),
							Integer.parseInt(idProfField.getText()), cpfProfField.getText(),
							dataContratacaoProfField.getText());
		...
		enviarAlunoButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (camposCadastroPreenchidos(nomeAlunoField, idAlunoField, cpfAlunoField, emailAlunoField,
						dataInscricaoAlunoField, studentLevelField)) {

					Student student = new Student(nomeAlunoField.getText(), emailAlunoField.getText(),
							Integer.parseInt(idAlunoField.getText()), cpfAlunoField.getText(),
							dataInscricaoAlunoField.getText(), studentLevelField.getText());
		...
		enviarCourseButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (camposCadastroPreenchidos(nomeCourseField, idCourseField, anoFundacaoCourseField,
						descricaoCourseField, escolherEscolaCourse, escolherProfessorCourse)) {
					Course curso = new Course(nomeCourseField.getText(), Integer.parseInt(idCourseField.getText()),
							Integer.parseInt(anoFundacaoCourseField.getText()), descricaoCourseField.getText(), null);
